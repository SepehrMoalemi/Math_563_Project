...
function [kernel, b] = add_blur(I, type, args, padding, show)
    arguments 
        I    double
        type string {mustBeMember(type, ...
                                    {'average',  ...
                                     ...
                                     'laplacian' ...
                                     'motion' ...
                                     'none'})}    = salsa.defaults.get_blurring_def();
        args cell                                 = salsa.defaults.get_blurring_def(type);
    ...
    if strcmp(type, 'none')
        ...
        if isempty(args)
            args = salsa.defaults.get_blurring_def(type);
        end
    ...
    if show
        ...
        salsa.img.display(b, fig_name, title_msg)
    end
end