%% Purpose: Apply Blur and Noise to Image
function [I, kernel, b] = corrupt(file_path, ...
                                  blur_type, blur_arg, ...
                                  noise_type, noise_arg, ...
                                  pad_type, ...
                                  show)
    arguments
        file_path char {mustBeFile(file_path)}  = salsa.defaults.get_img_def()
    ...
    % Add Noise
    b = salsa.img.add_noise(b, noise_type, noise_arg, show.noise);
end